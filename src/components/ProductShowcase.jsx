...
const ProductShowcase = () => {
  ...
  return (
    <div className='flex justify-center items-center flex-col'>
      ...
      <div className='flex justify-center items-center flex-col'>
        <div className='flex justify-center items-center flex-col --ease-in-expo transition-all my-10 mt-30 gap-30 '>
          <DBJlogo className={'scale-500 hover:scale-600 transition-all ease-in-out duration-500 text-gray-950 hover:text-red-800'}  />
